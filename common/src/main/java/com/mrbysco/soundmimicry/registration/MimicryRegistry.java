...
public class MimicryRegistry {
    ...
    public static final RegistryObject<SoundEmitterBlock> SOUND_EMITTER = BLOCKS.register("sound_emitter", () ->
            new SoundEmitterBlock(Block.Properties.of().mapColor(MapColor.TERRACOTTA_BLUE).strength(0.8F).sound(SoundType.METAL).noOcclusion()));
    public static final RegistryObject<BlockItem> SOUND_EMITTER_ITEM = ITEMS.register("sound_emitter", () -> new BlockItem(SOUND_EMITTER.get(), new Item.Properties()));
